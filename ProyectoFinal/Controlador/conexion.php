...
$host_db = "localhost:3306";  // Dirección del servidor de base de datos y puerto (3307)
$user_db = "root";            // Usuario de la base de datos
$pass_db = "Mf24@x";          // Contraseña del usuario
$db_name = "registro_visitas"; // Nombre de la base de datos a la que se desea conectar
