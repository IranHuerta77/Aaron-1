...
// Crear la consulta SQL para eliminar un registro de la tabla 'visitantes' según el número de teléfono proporcionado
$consulta = "DELETE FROM visitantes WHERE telefono = ";
