...
$nombreUser = $_POST['nombre_visita'];
$letraEdificio = $_POST['letra_torre'];
$numeroDepartamento = $_POST['numero_depa'];
$email = $_POST['email'];
$telefono = $_POST['telefono'];
$password = $_POST['password'];

// Verificar si el nombre de usuario ya existe en la base de datos
$buscarUsuario = "SELECT * FROM visitantes WHERE nombre_visita = ?";
...
$buscarTelefono = "SELECT * FROM visitantes WHERE telefono = ?";
// Preparar la consulta para prevenir inyecciones SQL
...
elseif ($countTelefono > 0) {
    ...
    try {
        // Consulta SQL para insertar un nuevo registro en la tabla 'visitantes'
        $insertar = "INSERT INTO visitantes (nombre_visita, letra_torre, numero_depa, email, telefono, password) 
                     VALUES ('$_POST[nombre_visita]', '$_POST[letra_torre]', '$_POST[numero_depa]', '$_POST[email]', '$_POST[telefono]', '$_POST[password]')";
